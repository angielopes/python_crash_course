...
administrator_1.privileges.show_privileges()

print(isinstance(administrator_1, Admin))
print(isinstance(administrator_1, User))
print(isinstance(administrator_1, Privileges))